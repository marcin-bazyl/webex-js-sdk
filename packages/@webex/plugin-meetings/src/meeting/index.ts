...
export default class Meeting extends StatelessWebexPlugin {
  ...
  async publishTracks(tracks: {
    ...
    if (tracks.microphone) {
      ...
      this.audio.handleLocalTrackMuteStateChange(this, localTrack.muted); // todo: this could be called from createMuteState automatically once we convert transcoded code too
    ...
    if (tracks.camera) {
      ...
      this.video.handleLocalTrackMuteStateChange(this, localTrack.muted); // todo: this could be called from createMuteState automatically once we convert transcoded code too
