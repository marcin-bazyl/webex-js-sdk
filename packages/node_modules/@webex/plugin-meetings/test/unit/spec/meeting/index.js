    ...
    describe('Public Api Contract', () => {
      ...
      describe('#addMedia', () => {
        ...
        beforeEach(() => {
          ...
          Media.createMediaConnection = sinon.stub().returns(Promise.resolve({}));
      ...
      describe('#updateMedia', () => {
        ...
        it('should use a queue if currently busy', async () => {
          ...
          assert.notCalled(Media.updateMedia); // todo, now this should check meeting.mediaProperties.webrtcMediaConnection.updateSendReceiveOptions instead
    ...
    describe('Private Detailed API and Helpers', () => {
      ...
      describe('#closePeerConnections', () => {
        it('should close the peer connections, and return a promise', async () => {
          meeting.mediaProperties.webrtcMediaConnection.close = sinon.stub().returns(Promise.resolve());
