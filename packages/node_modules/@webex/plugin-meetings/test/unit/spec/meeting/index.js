    ...
    describe('Public Api Contract', () => {
      ...
      describe('#usePhoneAudio', () => {
        ...
        it('rejects if the request failed (dial in)', () => {
          ...
          return meeting.usePhoneAudio().then(() => Promise.reject('Promise resolved when it should have rejected')).catch((e) => {
        ...
        it('rejects if the request failed (dial out)', async () => {
          ...
          return meeting.usePhoneAudio('+441234567890').then(() => Promise.reject('Promise resolved when it should have rejected')).catch((e) => {
            assert.equal(e, error);
