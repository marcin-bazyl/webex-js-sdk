...
describe('plugin-meetings', () => {
  describe('LocusInfo index', () => {
    ...
    describe('#updateSelf', () => {
      ...
      it('should trigger SELF_LOCAL_UNMUTE_REQUIRED on localAudioUnmuteRequired', () => {
        locusInfo.self = self;
        ...
        LOCUSINFO.EVENTS.SELF_LOCAL_UNMUTE_REQUIRED,
        {});
      });

      it('should trigger SELF_REQUEST_TO_UNMUTE_RECEIVED when receiving requestedToUnmute=true', () => {
        locusInfo.self = self;
        ...
        LOCUSINFO.EVENTS.SELF_REQUEST_TO_UNMUTE_RECEIVED,
        {});

        // now change requestedToUnmute back to false -> it should NOT trigger SELF_REQUEST_TO_UNMUTE_RECEIVED
