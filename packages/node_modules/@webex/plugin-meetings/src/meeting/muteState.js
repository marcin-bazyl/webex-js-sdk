...
class MuteState {
  ...
  sendLocalMuteRequestToServer() {
    ...
    let audioMuted = (meetingAudio ? meetingAudio.muted : true); // todo: this is probably wrong should be meetingAudio.state.client.localMute, or just use undefined - seems to work
    ...
    return MeetingUtil.remoteUpdateAudioVideo(audioMuted, videoMuted, this.meeting)
      .then((locus) => {
        ...
        this.meeting.locusInfo.onFullLocus(locus);
