...
class MuteState {
  ...
  sendLocalMuteRequestToServer() {
    const audioMuted = (this.type === TYPE_AUDIO) ? this.state.client.localMute : undefined;
    const videoMuted = (this.type === TYPE_VIDEO) ? this.state.client.localMute : undefined;
