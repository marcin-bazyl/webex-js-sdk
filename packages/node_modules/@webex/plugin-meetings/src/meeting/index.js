  ...
  */
  ...
  setupMediaConnectionCallbacks = () => {
    this.mediaProperties.webrtcMediaConnection.on(MC.Event.ROAP_DONE, () => {
      ...
      // meeting.processNextQueuedMediaUpdate();  // todo: if we use the queue then uncomment this
    });
  ...
  addMedia(options = {}) {
    ...
    return MeetingUtil.validateOptions(options)
      .then(() => {
        ...
        return Media.getTurnServerInfo(this.mediaProperties, {
          meeting: this,
      ...
      .then((turnServerInfo) => {
        const mc = Media.attachMedia(this.mediaProperties, {
          meetingId: this.id,
