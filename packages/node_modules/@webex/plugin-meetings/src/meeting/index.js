  ...
  */
  ...
  setupMediaConnectionCallbacks = () => {
    ...
    this.mediaProperties.webrtcMediaConnection.on(MC.Event.REMOTE_TRACK_ADDED, (event) => {
      LoggerProxy.logger.log(`Meeting:index#setupMediaConnectionCallbacks --> REMOTE_TRACK_ADDED event received for webrtcMediaConnection: ${JSON.stringify(event)}`);
      ...
      switch (event.type) {
        ...
        case MC.RemoteTrackType.SCREENSHARE_VIDEO:
          ...
          break;
        default: {
          LoggerProxy.logger.log('Meeting:index#setupMediaConnectionCallbacks --> unexpected track');
        }
      }
      ...
      switch (event.state) {
        ...
        case MC.ConnectionState.DISCONNECTED:
          ...
          this.reconnectionManager.waitForIceReconnect()
            .catch(() => {
              LoggerProxy.logger.info('Meeting:index#setupMediaConnectionCallbacks --> state DISCONNECTED, automatic reconnection timed out.');
