  ...
  */
  ...
  setupMediaConnectionCallbacks = () => {
    ...
    this.mediaProperties.webrtcMediaConnection.on(MC.Event.REMOTE_TRACK_ADDED, (event) => {
      ...
      if ((eventType === EVENT_TYPES.REMOTE_SHARE) && (this.config.experimental.shareReceiverTransform?.worker)) {
        ...
        console.log('marcin: setting up shareReceiverTransform');
        // event.receiver.transform = new RTCRtpScriptTransform(this.config.experimental.shareReceiverTransform.worker, {name: 'receiverTransform'});
      }
    });
