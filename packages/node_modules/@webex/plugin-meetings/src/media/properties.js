...
export default class MediaProperties {
  ...
  constructor(options = {}) {
    ...
    this.remoteVideoSlots = Array.from({length: options.remoteVideoSlotsCount || 5}, () => ({
      state: MC.SlotState.NO_SOURCE,
      csi: undefined,
      memberId: undefined
    }));
    this.activeSpeakerMemberIds = [];
  ...
  setMediaPeerConnection(peerConnection) {
    ...
    this.webrtcMediaConnection = peerConnection;
  }
