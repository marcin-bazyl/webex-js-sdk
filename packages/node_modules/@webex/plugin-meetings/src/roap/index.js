...
export default class Roap extends StatelessWebexPlugin {
    ...
    return Promise.resolve().then(() => {
      ...
      return this.roapRequest
        .sendRoap({
          ...
          preferTranscoding: meeting.preferTranscoding
        })
        .then(() => {
          // this.roapHandler.submit({
   ...
   * @memberof Roap
   */
  sendRoapAnswer(options) { // todo: use this to send the answer
    const meeting = this.webex.meetings.meetingCollection.getByKey('correlationId', options.correlationId);
    const roapMessage = {
   ...
   * @memberof Roap
   */
  sendRoapCallRequest = (options) => { // todo remove this, it's unused
