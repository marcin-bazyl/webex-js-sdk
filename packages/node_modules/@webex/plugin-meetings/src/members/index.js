...
export default class Members extends StatelessWebexPlugin {
   ...
   * @memberof Members
   */
  muteMember(memberId, mute = true, requestToUnmute = undefined) {
    if (!this.locusUrl) {
    ...
    const options = MembersUtil.generateMuteMemberOptions(memberId, mute, requestToUnmute, this.locusUrl);
