...
export default class ReconnectionManager {
  ...
  isReconnectInProgress() {
    console.log(`marcin: isReconnectInProgress: ${this.status}`);
  ...
  reconnectMedia() {
    ...
    // todo.... confirm if these changes are OK, make sure we do everything that setupPeerConnection() used to do

    console.log('marcin: this.meeting.mediaProperties:', this.meeting.mediaProperties);
    // close current webrtc media connection
    // this.meeting.mediaProperties.webrtcMediaConnection.close();
    // this.meeting.mediaProperties.unsetPeerConnection();

    // this.meeting.mediaId = '';

    // console.log('marcin: calling attachMedia');
    // and create a new one
    // const mc = Media.attachMedia(this.meeting.mediaProperties, {
    ...
    // console.log('marcin: part 2');
    // this.meeting.mediaProperties.setMediaPeerConnection(mc);
    // this.meeting.setupMediaConnectionCallbacks();

    // todo: update statsAnalyzer with the new media connection
    // console.log('marcin: part 3 - final');
    console.log('marcin: !!!!!!!!! calling reconnect()');

    return this.meeting.mediaProperties.webrtcMediaConnection.reconnect();
    // return this.meeting.mediaProperties.webrtcMediaConnection.initiateOffer();
    // todo: here the old code was sending the roap SDP offer (sendRoapMediaRequest) with reconnect:true, so the request would be sent
    // with empty mediaId, now instead we are resetting this.meeting.mediaId above, check if this works
  }
