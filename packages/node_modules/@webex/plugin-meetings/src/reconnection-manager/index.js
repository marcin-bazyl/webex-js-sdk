...
export default class ReconnectionManager {
  ...
  reconnectMedia() {
    ...
    // todo: the old code also worked if there was no media connection at all (used in rejoin case), we need to make sure the new code now also handles this case
    // so need to create a webrtcMediaConnection if there isn't one
    // and make sure meeting.statsAnalyzer.updatePeerconnection is called on that new one
