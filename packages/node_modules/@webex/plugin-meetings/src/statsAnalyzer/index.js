...
export class StatsAnalyzer extends EventsScope {
  ...
  getStatsAndParse() {
    ...
    if (this.peerConnection && this.peerConnection.getConnectionState() === MC.ConnectionState.FAILED) {
    ...
    return this.peerConnection.getTransceiverStats().then((transceiverStats) => {
