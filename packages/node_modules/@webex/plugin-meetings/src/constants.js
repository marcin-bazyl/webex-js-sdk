...
const LOCUS_AS_ICE_SERVER = {
  urls: 'turns:openrelay.metered.ca:443', // 'turn:gmt-pacmsedge02.cisco.com:3478?transport=udp', // 'turns:external-media84.public.wlhrm-a-2.prod.infra.webex.com:443?transport=tcp',
  username: 'openrelayproject', // 'marcin',
  credential: 'openrelayproject' // 'secretpassword'
};

export const RTC_CONFIGURATION_FIREFOX = {
  iceServers: [LOCUS_AS_ICE_SERVER],
