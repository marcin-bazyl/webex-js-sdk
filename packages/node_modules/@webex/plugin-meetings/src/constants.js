...
export const EVENT_TRIGGERS = {
  ...
  MEDIA_REMOTE_VIDEO_SOURCES_CHANGED: 'media:remoteVideoSources:changed',
  MEDIA_ACTIVE_SPEAKERS_CHANGED: 'media:activeSpeakers:changed',
...
export const RTC_CONFIGURATION = {iceServers: [], encodedInsertableStreams: true};
