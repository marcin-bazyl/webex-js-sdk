  ...
  CONFIG: {
    senders: {
      audio: {
        ...
        peerConnection: 'peerConnection', // todo: this needs to be webrtcMediaConnection and we need a new getStats() API
        name: 'audioSender'
      },
      video: {
...
// these values must match allowed values of RemoteQualityLevel from the @webex/webrtc-media lib
